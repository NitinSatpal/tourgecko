$(function() {
  ...
  var TourSlider = new MasterSlider();
  TourSlider.setup('masterslider-preview' , {
    space: 1,
    speed: 70,
    layout: 'autofill',
    loop: true,
  ...
  // adds Arrows navigation control to the TourSlider.
  // TourSlider.control('arrows');
  TourSlider.control('lightbox');
});
