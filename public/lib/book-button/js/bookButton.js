...
$('.tourgeckoSpecificTourBookButton').stickyfloat({offsetY: 300});

// after page refresh, make sure the values are returned to their defaults
$('.tourgeckoSpecificTourBookButton :text').each(function(){
	$(this).val(this.defaultValue);
});

$('.tourgeckoToursiteBookButton').stickyfloat({offsetY: 300});

// after page refresh, make sure the values are returned to their defaults
$('.tourgeckoToursiteBookButton :text').each(function(){
	$(this).val(this.defaultValue);
});